...
const Card = ({name, discount, _id, likes, wight, description, pictures, price, userCurrent, onLiked}) => {
	...
	return (
		<div className="card">
			...
			<button className={cn('card__favorite', {'card__favorite-active': isLike})} onClick={handleLiked}>
			...
			<Link to={`/product/${_id}`} className="card__link">
				...
				<div className="card__desc">
					...
					{discount !== 0 && <span className="card__price card__price_type_discount">{newPrice}&nbsp;₽</span>}
